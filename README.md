...
| 3.2.1 | Updated Oracle.ManagedDataAccess.Client library and added functionality to replace invalid xml characters with underscore '_'. Fixed also workflows. |
